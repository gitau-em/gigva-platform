...
export const metadata = {
  ...
  description: 'Gigva automates M-Pesa reconciliation, inventory tracking, and daily sales reports for Kenyan retail shops — supermarkets, dukas, and convenience stores.',
...
const RETAIL_FEATURES = [
  {
    ...
    desc: 'Every M-Pesa Paybill and Till payment is matched to a sale within seconds. Mixed payment (cash + M-Pesa) is tracked separately. End-of-day totals are generated automatically — no manual counting.',
  },
  {
    icon: Package,
  ...
  },
  {
    ...
    desc: 'See today's revenue by the hour, best-selling products, and payment method breakdown — M-Pesa, cash, and card — on one screen. Filter by date, cashier, or product category.',
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    desc: 'Assign each cashier a unique login. Track sales, voids, and refunds per cashier. If you run multiple branches, each location gets its own dashboard — consolidated reports show the full picture.',
  },
]
...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    detail: 'Use Gigva's browser-based POS to record cash, M-Pesa, and card sales. Cashiers select items, enter quantities, and confirm payment. Each sale updates inventory in real time.',
  },
  {
    step: 3,
    title: 'Gigva reconciles every payment automatically',
    detail: 'When a customer pays via M-Pesa, Safaricom sends a callback to Gigva within 3–5 seconds. Gigva matches the payment to the open sale, marks it paid, and deducts stock.',
  },
  {
    step: 4,
      ...
      <section className="py-14 px-5 md:px-8 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-8">
            {[
              { name: "Starter", price: "KSh 2,999", detail: "Up to 500 txns/mo · 1–3 cashiers · 1 branch", highlight: false },
