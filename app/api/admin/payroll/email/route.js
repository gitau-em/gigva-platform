...
function buildPayslipHtml(slip, emp) {
  ...
  const monthName = monthNames[(slip.period_month || 1) - 1]
  const items = [
...
.hdr{background:#1a56db;color:#fff;padding:6px 10px;font-weight:bold;}
</style></head><body>
<div style="text-align:center;margin-bottom:4px;">
  <img src="${SITE_URL}/logo.png" alt="Gigva" style="height:48px;" />
</div>
<h2 style="text-align:center;color:#1a56db;margin:4px 0 2px;">GIGVA KENYA</h2>
<p style="text-align:center;font-size:11px;margin:0 0 8px;">Westlands Business Park, Nairobi, Kenya 00100 &bull; +254 701 443 444 &bull; hello@gigva.co.ke &bull; www.gigva.co.ke</p>
<hr/>
...
<table style="border:1px solid #ccc;margin-bottom:12px;">
  <tr class="hdr"><td colspan="3"><b>Personal Details</b></td></tr>
  ...
  <tr><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>PHONE:</b> ${emp.phone || ''}</td><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>ID NO:</b> ${emp.id_number || ''}</td><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>PERIOD END:</b> ${slip.period_end || ''}</td></tr>
  <tr><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>EMAIL:</b> ${emp.email || ''}</td><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>DATE EMPLOYED:</b> ${emp.date_employed || ''}</td><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>BANK ACCOUNT:</b> ${emp.bank_account || ''}</td></tr>
  <tr><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>MARITAL STATUS:</b> ${emp.marital_status || 'Single'}</td><td style="padding:4px 8px;border:1px solid #d0d8e8;"></td><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>BANK NAME:</b> ${emp.bank_name || ''} | <b>CODE:</b> ${emp.bank_code || ''}</td></tr>
</table>
${(slip.leave_balance_days || slip.leave_from) ? `<table style="border:1px solid #ccc;margin-bottom:12px;">
  <tr class="hdr"><td colspan="3"><b>Leave Details</b></td></tr>
  <tr><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>Leave Balance:</b> ${slip.leave_balance_days || 0} days</td><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>Leave Taken:</b> ${slip.leave_from || ''} to ${slip.leave_to || ''}</td><td style="padding:4px 8px;border:1px solid #d0d8e8;"><b>Days Taken:</b> ${slip.leave_days_taken || 0}</td></tr>
</table>` : ''}
<table style="border:1px solid #ccc;margin-bottom:20px;">
  <tr style="background:#1a56db;color:#fff;"><th style="padding:6px 8px;border:1px solid #4a7ae8;">Item</th><th style="padding:6px 8px;border:1px solid #4a7ae8;">Code</th><th style="padding:6px 8px;border:1px solid #4a7ae8;">Name</th><th style="padding:6px 8px;border:1px solid #4a7ae8;">Qty/Rate</th><th style="padding:6px 8px;border:1px solid #4a7ae8;">Amount</th><th style="padding:6px 8px;border:1px solid #4a7ae8;">Total</th></tr>
  ${rows}
</table>
<table style="width:100%;"><tr>
  ...
  <td style="width:50%;text-align:right;vertical-align:top;">
    <p style="font-size:12px;">Authorized Signature: _______________________</p>
  </td>
</tr></table>
<hr/>
<p style="text-align:center;font-size:10px;color:#666;">Gigva Kenya &bull; +254 701 443 444 &bull; hello@gigva.co.ke &bull; www.gigva.co.ke</p>
</body></html>`
}
