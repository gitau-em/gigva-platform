...
export const metadata = {
  title: {
    default: 'Gigva — M-Pesa Reconciliation for Kenyan SMBs',
    template: '%s | Gigva Kenya',
  },
  description:
    'Gigva automatically reconciles M-Pesa transactions for Kenyan retail shops, logistics firms, and SMEs. Real-time dashboard, invoice matching, and financial reports — from KSh 2,999/month.',
  keywords: [
