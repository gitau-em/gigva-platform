...
function initSchema(database) {
  ...
  database.exec(`
    ...
    CREATE TABLE IF NOT EXISTS payroll_payslips (
      ...
      annual_leave_entitlement INTEGER DEFAULT 25,
  ...
  try {
    ...
    const payslipMissingCols = [
      ...
      { name: 'annual_leave_entitlement', def: 'INTEGER DEFAULT 25' },
      { name: 'annual_leave_taken',       def: 'INTEGER DEFAULT 0' },
      { name: 'annual_leave_balance',     def: 'INTEGER DEFAULT 25' },
      { name: 'sick_leave_entitlement',   def: 'INTEGER DEFAULT 10' },
      { name: 'sick_leave_taken',         def: 'INTEGER DEFAULT 0' },
      { name: 'sick_leave_balance',       def: 'INTEGER DEFAULT 10' },
