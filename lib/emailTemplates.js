        ...
        <tr>
          <td style="background:#f1f5f9;padding:16px 28px;border-top:1px solid #e2e8f0;">
            <p style="margin:0;font-size:11px;color:${FOOTER_COLOR};line-height:1.6;">
              ...
              <a href="https://gigvakenya.co.ke" style="color:${BRAND_COLOR};text-decoration:none;">gigvakenya.co.ke</a>
              &nbsp;·&nbsp;
              <a href="mailto:ceo@gigva.co.ke" style="color:${BRAND_COLOR};text-decoration:none;">ceo@gigva.co.ke</a>
            </p>
            <p style="margin:8px 0 0;font-size:10px;color:#94a3b8;">
              This is an automated notification from the Gigva platform.
            </p>
          </td>
        </tr>
