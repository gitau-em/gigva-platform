...
// === EMAIL FOOTER BRANDING BLOCK ===
// Returns HTML string with Gigva logo, company name, website, and contact.
// Uses absolute URL for logo (required for email clients).
// Logo: compact variant, 100px width (email-safe size)
function emailFooterBlock() {
  const base = process.env.NEXT_PUBLIC_SITE_URL || 'https://gigva.co.ke'
  const logoSrc = base + '/gigva-logo.png'
  const logoW = 100
  const logoH = 26 // approx aspect ratio 80/304 * 100
  return (
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">' +
    '<tr><td style="padding-bottom:12px;">' +
    '<img src="' + logoSrc + '" alt="Gigva Kenya" width="' + logoW + '" height="' + logoH + '" ' +
    'style="display:block;border:0;outline:none;width:' + logoW + 'px;height:auto;max-width:' + logoW + 'px;" />' +
    '</td></tr>' +
    '<tr><td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;font-weight:700;color:#0ea5e9;letter-spacing:1px;padding-bottom:4px;">GIGVA KENYA</td></tr>' +
    '<tr><td style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#94a3b8;padding-bottom:2px;">' +
    '<a href="https://gigva.co.ke" style="color:#0ea5e9;text-decoration:none;">www.gigva.co.ke</a>' +
    '</td></tr>' +
    '<tr><td style="font-family:Arial,Helvetica,sans-serif;font-size:11px;color:#94a3b8;">' +
    '<a href="mailto:hello@gigva.co.ke" style="color:#94a3b8;text-decoration:none;">hello@gigva.co.ke</a>' +
    '</td></tr>' +
    '</table>'
  )
}
